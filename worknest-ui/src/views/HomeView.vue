<template>
  ...
  >
    <p class="text-h2">
      Hi <span class="font-weight-bold">{{ user.name }} {{ user.surname }}</span
      >!
    </p>
    <p v-if="user.type === 'ADMINISTRATOR'" class="text-h5 font-italic">
      Welcome admin
    </p>
    <p v-else-if="user.type === 'BUSINESS'" class="text-h5 font-italic">
