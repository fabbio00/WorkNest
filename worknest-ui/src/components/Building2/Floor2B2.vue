...
<template>
  <svg
    width="1800.0000000000005"
    height="900.0000000000002"
  ...
  >
    ...
    <g id="meeting_room">
      ...
      <rect
        :fill="
          occupiedDesks.includes('35fb2a32-091d-4421-a02a-ccd351237c9d') ||
          userType !== 'business'
            ? 'red'
            : 'green'
        "
        ...
        rx="8"
        stroke="#000"
        data-id="35fb2a32-091d-4421-a02a-ccd351237c9d"
    ...
    <g id="meeting_room">
      ...
      <rect
        :fill="
          occupiedDesks.includes('d9efb8a9-bebb-42b4-a7bd-a6439bf013d8') ||
          userType !== 'business'
            ? 'red'
            : 'green'
        "
        ...
        rx="8"
        stroke="#000"
        data-id="d9efb8a9-bebb-42b4-a7bd-a6439bf013d8"
        @click="handleMeetingRoomClick"
      />
      <rect
        fill="#f2efef"
