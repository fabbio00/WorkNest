...
describe('HomeView', () => {
    ...
    it('fetches user data before mount', () => {
        expect(mockApiService.find_user_by_id).toHaveBeenCalledWith(localStorage.getItem('userId'));
    });
    ...
    it('applies zoomIn animation class on image transition', () => {
        ...
        expect(imageTransition.props('enterActiveClass')).toBe('animate__animated animate__zoomIn');
    });
});
