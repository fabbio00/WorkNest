...
// ------- adimin buttons tests -------
    ...
    it('does not show admin buttons for non ADMINISTRATOR user', async () => {
      ...
      expect(wrapper.find('[prepend-icon="mdi-office-building-plus"]').exists()).toBe(false);
      expect(wrapper.find('[prepend-icon="mdi-calendar-multiple"]').exists()).toBe(false);
      expect(wrapper.find('[prepend-icon="mdi-domain"]').exists()).toBe(false);
      expect(wrapper.find('[prepend-icon="mdi-account-multiple"]').exists()).toBe(false);
    });
    ...
    it('does not show admin buttons for ADMINISTRATOR user', async () => {
      ...
      expect(wrapper.find('[prepend-icon="mdi-calendar-month-outline"]').exists()).toBe(false);
      expect(wrapper.find('[prepend-icon="mdi-calendar-plus-outline"]').exists()).toBe(false);
    });
